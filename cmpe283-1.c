...
/* I have commented this struct code because based on the output of Primary procbased controls, I got to know that I can not set Tertiary Controls for my Linux Kernel */
/* 
...
detect_vmx_features(void)
{
	...
	/* The code given as below is for Tertiary procbased controls */

	/* I have commented this code because based on the output of Primary procbased controls, I got to know that I can not set Tertiary Controls for my Linux Kernel */

	/* Note: If you uncomment this code and if your linux kernel does not provide tertiary procbased controls then you will get an error. */
...
init_module(void)
{
	printk(KERN_INFO "CMPE 283 Assignment 1 - Harsh Vaghasiya Module Start\n");
...
cleanup_module(void)
{
	printk(KERN_INFO "CMPE 283 Assignment 1 - Harsh Vaghasiya Module Exits\n");
}